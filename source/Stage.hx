...
class Stage extends MusicBeatState
{
	...
	public function new(daStage:String)
	{
		...
		switch (daStage)
		{
			case 'spongegod' | 'spongegod-old':
				{
					camZoom = 0.9;
					curStage = 'spongestage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('yellowdarkness', 'shared'));
					...
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('spongestage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'yeehaw' | 'texas':
				{
					camZoom = 0.9;
					curStage = 'sandystage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('browndarkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('sandystage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'alone':
				{
					camZoom = 0.9;
					curStage = 'bed';
					var bg:FlxSprite = new FlxSprite(300, -320).loadGraphic(Paths.loadImage('bed', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					...
					var bg:FlxSprite = new FlxSprite(10, -440).loadGraphic(Paths.loadImage('darkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'slenderpants | slenderpants-old':
				{
					camZoom = 0.9;
					curStage = 'forest';
					var bg:FlxSprite = new FlxSprite( -1050, -640).loadGraphic(Paths.loadImage('forest', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-750, -500).loadGraphic(Paths.loadImage('darkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'yum':
				{
					camZoom = 0.9;
					curStage = 'KB';
					var bg:FlxSprite = new FlxSprite(-250, -840).loadGraphic(Paths.loadImage('KB', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-250, -840).loadGraphic(Paths.loadImage('KB2', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-250, -840).loadGraphic(Paths.loadImage('darkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'invalid' | 'futuristic':
				{
					camZoom = 0.9;
					curStage = 'davestage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('bambistage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('greendarkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'kahrahtae':
				{
					camZoom = 0.9;
					curStage = 'spongebotstage';
					var bg:FlxSprite = new FlxSprite(-1000, -650).loadGraphic(Paths.loadImage('spongebotstage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-1000, -650).loadGraphic(Paths.loadImage('reddarkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'fantastic' | 'spongecorn':
				{
					camZoom = 0.9;
					curStage = 'farm';
					var bg:FlxSprite = new FlxSprite(-240, 305).loadGraphic(Paths.loadImage('sky', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-240, 305).loadGraphic(Paths.loadImage('farm', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'fishpaste':
				{
					camZoom = 0.9;
					curStage = 'farm';
					var bg:FlxSprite = new FlxSprite(-240, 305).loadGraphic(Paths.loadImage('nightsky', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(680, 1080).loadGraphic(Paths.loadImage('phone', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-240, 305).loadGraphic(Paths.loadImage('nightoverlay', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'unethical':
				{
					camZoom = 0.9;
					curStage = 'expungedstage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('expungedstage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('reddarkness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'schoolhouse':
				{
					camZoom = 0.9;
					curStage = 'schoolhouse';
					var bg:FlxSprite = new FlxSprite(150, -380);
					bg.frames = Paths.getSparrowAtlas('schoolhouse', 'shared');
					bg.animation.addByPrefix('dance', 'schoolhouse 2', 24);
			...
			case 'chocolate':
				{
					camZoom = 0.9;
					curStage = 'chocolatestage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('chocolatestage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'useless':
				{
					camZoom = 0.9;
					curStage = 'bootlegstage';
					var bg:FlxSprite = new FlxSprite(100, 300).loadGraphic(Paths.loadImage('blindness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(100, 300).loadGraphic(Paths.loadImage('bootlegstage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'eternality':
				{
					camZoom = 0.9;
					curStage = 'davething';
					var bg:FlxSprite = new FlxSprite(-440, 405).loadGraphic(Paths.loadImage('sky', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-140, 415).loadGraphic(Paths.loadImage('davething', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'holy-krab':
				{
					camZoom = 0.9;
					curStage = 'krabsstage';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('krabsstage', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'haunted-mattress':
				{
					camZoom = 0.9;
					curStage = 'pineapplehouse';
					var bg:FlxSprite = new FlxSprite(-440, 160).loadGraphic(Paths.loadImage('house', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(1340, 1050);
					bg.frames = Paths.getSparrowAtlas('gary', 'shared');
					bg.animation.addByPrefix('dance', 'gary 2', 24);
					bg.animation.play('dance');
					bg.scrollFactor.set(0.8, 0.9);
					bg.scale.set(6, 6);
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-290, 160).loadGraphic(Paths.loadImage('coral', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
			...
			case 'boundary':
				{
					camZoom = 0.9;
					curStage = 'sb129';
					var bg:FlxSprite = new FlxSprite(-650, -350).loadGraphic(Paths.loadImage('SB129', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
					...
					var bg:FlxSprite = new FlxSprite(-280, -100).loadGraphic(Paths.loadImage('blindness', 'shared'));
					bg.antialiasing = FlxG.save.data.antialiasing;
					bg.scrollFactor.set(0, 0);
					bg.active = false;
					swagBacks['bg'] = bg;
